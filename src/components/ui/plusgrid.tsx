...
export function PlusGridRow({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-x-0 top-0 border-t border-primary/10"></div>
        <div className="absolute inset-x-0 top-2 border-t border-primary/10"></div>
        <div className="absolute inset-x-0 bottom-0 hidden border-b group-last/row:block border-primary/10"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b  group-last/row:block border-primary/10"></div>
      </div>
      {children}
    </div>
  );
